...
<head>
    ...
    <title>Report Incident - Attendant</title>
...
<div class="dashboard-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section"><div class="menu-section-title">Safety</div><a href="report_incident.php" class="menu-item active">Report Incident</a></div>
        ...
        <div class="dashboard-content">
            ...
            <div class="content-section">
                ...
                <div class="form-section">
                    ...
                    <!-- STEP 1: Date filter -->
                    <form method="GET" action="report_incident.php" name="dateForm" onsubmit="return validateDateFilter()">
                        <div class="filter-bar">
                            ...
                            <div class="filter-group" style="justify-content:flex-end;"><label>&nbsp;</label>
                                <div style="display:flex;gap:0.5rem;">
                                    ...
                                    <a href="report_incident.php" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form method="POST" action="report_incident.php" name="incidentForm" onsubmit="return validateIncidentForm()">
