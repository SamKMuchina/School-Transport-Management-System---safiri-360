<?php
/**
 * start_trip_view.php (ATTENDANT copy)
 *
 * DISPLAY ONLY - no database queries, no business logic.
 *
 *
 * Every button here is a plain HTML form. Clicking Pickup, Absent, or
 */
?>
<html>
<head>
    ...
    <title>Trip Execution - Attendant</title>
...
<div class="trip-execution-card">
    ...
    <div class="page-header">
        <h1>Trip Execution - Attendant</h1>
