<?php
/**
 * attendant_reports.php - Attendant Reports
 *
 * Two tabs: Trip History and Incident Log.
 * Both tabs share the same top date range filter.
 * Default date range is blank - user must enter dates to see results.
 *
 * Location  : attendant/attendant_reports.php
...
// ============================================================
// DATE RANGE - blank by default
// ============================================================

/*
 * Both tabs share the same date_from and date_to filter.
 * Default is blank - no results shown until the user filters.
 * Both tabs are filtered simultaneously when the form is submitted.
 */
...
if ($filter_applied) {
    ...
    $r  = mysqli_query($conn, "SELECT t.trip_date, r.route_name, v.plate_no, t.start_time, t.end_time, t.status,
                                ...
                                WHERE t.attendant_id = $attendant_id AND t.trip_date BETWEEN '$df' AND '$dt'
...
include 'attendant_reports_view.php';
