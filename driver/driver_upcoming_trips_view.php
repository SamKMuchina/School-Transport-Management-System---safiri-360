<?php
/**
 * driver_upcoming_trips_view.php - DISPLAY ONLY
 * Variables: $username, $total_upcoming, $trips_result
 * Rolling 7-day window. Completed Trips removed from sidebar.
 */
?>
<html>
<head>
    ...
    <title>Upcoming Trips - Driver</title>
...
<div class="dashboard-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section"><div class="menu-section-title">Trip Management</div><a href="driver_upcoming_trips.php" class="menu-item active">Upcoming Trips</a></div>
            ...
            <div class="content-section">
                ...
                <div class="table-wrapper">
                    <table class="data-table">
                        <thead><tr><th>Date</th><th>Route</th><th>Vehicle</th><th>Students</th><th>Status</th><th>Action</th></tr></thead>
                        <tbody>
                            <?php if ($total_upcoming > 0): ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="6" class="table-empty">No upcoming trips for the next 7 days.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
<script>
    ...
    function viewStudents(tripId){
        ...
        xhr.open("GET","driver_upcoming_trips.php?ajax=get_students&trip_id="+tripId,true);
