...
<div class="dashboard-container">
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section"><div class="menu-section-title">Reports</div><a href="driver_reports.php" class="menu-item active">My Reports</a></div>
    ...
    <div class="main-wrapper">
        ...
        <div class="dashboard-content">
            ...
            <form method="GET" action="driver_reports.php" name="filterForm" onsubmit="return validateFilterForm()">
                ...
                <div class="filter-bar mb-1">
                    ...
                    <div class="filter-group filter-group-actions"><label>&nbsp;</label>
                        <div class="button-group">
                            ...
                            <a href="driver_reports.php?tab=<?php echo $active_tab; ?>" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="report-tabs">
                <a href="driver_reports.php?tab=trips&date_from=<?php echo urlencode($date_from); ?>&date_to=<?php echo urlencode($date_to); ?>"
                   class="tab-link <?php echo $active_tab==='trips'?'active':''; ?>">Trip History</a>
                <a href="driver_reports.php?tab=incidents&date_from=<?php echo urlencode($date_from); ?>&date_to=<?php echo urlencode($date_to); ?>"
